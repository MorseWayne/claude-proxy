...
This project is indexed by GitNexus as **claude-proxy** (3586 symbols, 8985 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
