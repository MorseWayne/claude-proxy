...
This project is indexed by GitNexus as **claude-proxy** (3151 symbols, 8057 relationships, 280 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
