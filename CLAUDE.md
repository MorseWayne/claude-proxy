...
This project is indexed by GitNexus as **claude-proxy** (2907 symbols, 7300 relationships, 258 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
