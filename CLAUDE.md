...
This project is indexed by GitNexus as **claude-proxy** (3480 symbols, 8680 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
